...
import 'package:fruitshealthy_nhom2/services/api_client.dart';
import 'package:fruitshealthy_nhom2/services/auth_service.dart';
...
class Auth {
  ...
  static Future<Map<String, dynamic>> register({
    ...
    try {
      var response =
          await _apiClient.post('api/Authenticate/register', body: body);
